...
from scout.settings import MERCHANT_GAME_CLIENT_ADDRESS, MERCHANT_GAME_CLIENT_BASE
...
def index(request):
    ...
    return render(request, 'merchant_game/index.html', {
        'server_api_url': url,
        'client_url': "/".join((MERCHANT_GAME_CLIENT_ADDRESS, MERCHANT_GAME_CLIENT_BASE)),
    })
